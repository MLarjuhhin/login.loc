    ...
    <div class="d-flex align-items-center justify-content-center mt-5" >
        <div class="mt-5 pt-5">
            ...
            <form method="post" >
                ...
                <div class="form-group">
                    <label for="InputPasswordConfirm"><p class="font-weight-bold m-0">Parool</p></label>
                    <input type="password" class="form-control" id="InputPasswordConfirm"  name="login_passConfirm" >
                </div>
